...
class InfoDoctor extends StatelessWidget {
  ...
  final TextEditingController medicalSpeciality = TextEditingController();
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 10),
              CustomTextField(
                hintText: "Tell us your where you are from",
                isPassword: false,
                controller: city,
                validator: (value) {},
              ...
              Align(
                alignment: Alignment.centerLeft,
                child: CustomTitleTextFormField(title: "Medical speciality"),
              ),
              SizedBox(height: 10),
              CustomTextField(
